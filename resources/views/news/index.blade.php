...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="row g-4">
            <h2><i class="fas fa-align-justify"></i>Just In</h2>

            <div class="col-lg-7 col-xl-8 mt-0">
                <div class="position-relative overflow-hidden rounded">
                    <img src="{{ asset('public/news/img/news-1.jpg') }}" class="img-fluid rounded img-zoomin w-100" alt="">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="rounded overflow-hidden">
                            <img src="{{ asset('public/news/img/news-3.jpg') }}" class="img-fluid rounded img-zoomin w-100" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="row g-4 align-items-center">
                                <div class="col-5">
                                    <div class="overflow-hidden rounded">
                                        <img src="{{ asset('public/news/img/news-4.jpg') }}" class="img-fluid rounded img-zoomin w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="features-content d-flex flex-column">
                        ...
                        <div class="col-12">
                            <div class="row g-4 align-items-center">
                                <div class="col-5">
                                    <div class="overflow-hidden rounded">
                                        <img src="{{ asset('public/news/img/news-5.jpg') }}" class="img-fluid rounded img-zoomin w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="features-content d-flex flex-column">
                        ...
                        <div class="col-12">
                            <div class="row g-4 align-items-center">
                                <div class="col-5">
                                    <div class="overflow-hidden rounded">
                                        <img src="{{ asset('public/news/img/news-6.jpg') }}" class="img-fluid rounded img-zoomin w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="features-content d-flex flex-column">
                        ...
                        <div class="col-12">
                            <div class="row g-4 align-items-center">
                                <div class="col-5">
                                    <div class="overflow-hidden rounded">
                                        <img src="{{ asset('public/news/img/news-7.jpg') }}" class="img-fluid rounded img-zoomin w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="features-content d-flex flex-column">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <!-- First column with one data item -->
                                    <div class="col-lg-4">
                                        <div class="mn-img">
                                            <img src="{{ asset('public/news/img/features-fashion.jpg') }}">
                                        ...
                                        <div class="mn-content">
                                            ...
                                            <p>
                                                ...
                                                porta dui. Class aptent taciti sociosqu ad litora torquent per
                                                conubia nostra inceptos...
                                            </p>
                                        </div>
                                    </div>
                                    <!-- Second column with one data item -->
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <!-- First column with one data item -->
                                            <div class="col-lg-6">
            ...
            <div class="row g-4">
                <div class="col-lg-8 col-xl-9">
                    <div class="d-flex flex-column flex-md-row justify-content-md-between border-bottom mb-4">
                        ...
                        <!-- <ul class="nav nav-pills d-inline-flex text-center data1">
                                ...
                                <li class="nav-item mb-3">
                                    <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill"
                                        href="#tab-2">
                                        <span class="text-dark" style="width: 100px;">Magazine1</span>
                                    </a>
                                </li>
                                </li>
                                <li class="nav-item mb-3">
                                    <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill"
                                        href="#tab-2">
                                        <span class="text-dark" style="width: 100px;">Magazine2</span>
                                    </a>
                                </li>
                            </ul> -->
                        <ul class="nav nav-pills d-inline-flex text-center data1" id="listItems">
                            <li class="nav-item mb-3">
                        ...
                        <div style="position: relative;">
                            <button id="showMoreButton" style="border: none; position: absolute; top: 0; right: 0;">&#8230;</button>
                        </div>
                    ...
                    <div class="tab-content mb-4">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center">
                                                <div class="col-5">
                                                    <div class="overflow-hidden rounded">
                                                        <img src="{{ asset('public/news/img/news-3.jpg') }}" class="img-zoomin img-fluid rounded w-100" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-7">
                                                    <div class="features-content d-flex flex-column">
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center">
                                                <div class="col-5">
                                                    <div class="overflow-hidden rounded">
                                                        <img src="{{ asset('public/news/img/news-4.jpg') }}" class="img-zoomin img-fluid rounded w-100" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-7">
                                                    <div class="features-content d-flex flex-column">
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center">
                                                <div class="col-5">
                                                    <div class="overflow-hidden rounded">
                                                        <img src="{{ asset('public/news/img/news-5.jpg') }}" class="img-zoomin img-fluid rounded w-100" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-7">
                                                    <div class="features-content d-flex flex-column">
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center">
                                                <div class="col-5">
                                                    <div class="overflow-hidden rounded">
                                                        <img src="{{ asset('public/news/img/news-6.jpg') }}" class="img-zoomin img-fluid rounded w-100" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-7">
                                                    <div class="features-content d-flex flex-column">
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center">
                                                <div class="col-5">
                                                    <div class="overflow-hidden rounded">
                                                        <img src="{{ asset('public/news/img/news-7.jpg') }}" class="img-zoomin img-fluid rounded w-100" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-7">
                                                    <div class="features-content d-flex flex-column">
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-8">
                                    <div class="position-relative rounded overflow-hidden">
                                        <img src="{{ asset('public/news/img/news-1.jpg') }}" class="img-zoomin img-fluid rounded w-100" alt="">
                    ...
                    <div class="whats-carousel owl-carousel">
                        <div class="latest-news-item">
                            <div class="bg-light rounded">
                                <div class="rounded-top overflow-hidden">
                                    <img src="{{ asset('public/news/img/news-7.jpg') }}" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                </div>
                        ...
                        <div class="whats-item">
                            <div class="bg-light rounded">
                                <div class="rounded-top overflow-hidden">
                                    <img src="{{ asset('public/news/img/news-6.jpg') }}" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                </div>
                                <div class="d-flex flex-column p-4">
                                    <a href="#" class="h4">There are many variations of passages of Lorem Ipsum
                                        available,</a>
                        ...
                        <div class="whats-item">
                            <div class="bg-light rounded">
                                <div class="rounded-top overflow-hidden">
                                    <img src="{{ asset('public/news/img/news-3.jpg') }}" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                </div>
                                <div class="d-flex flex-column p-4">
                                    <a href="#" class="h4">There are many variations of passages of Lorem Ipsum
                                        available,</a>
                        ...
                        <div class="whats-item">
                            <div class="bg-light rounded">
                                <div class="rounded-top overflow-hidden">
                                    <img src="{{ asset('public/news/img/news-4.jpg') }}" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                </div>
                                <div class="d-flex flex-column p-4">
                                    <a href="#" class="h4">There are many variations of passages of Lorem Ipsum
                                        available,</a>
                        ...
                        <div class="whats-item">
                            <div class="bg-light rounded">
                                <div class="rounded-top overflow-hidden">
                                    <img src="{{ asset('public/news/img/news-5.jpg') }}" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                </div>
                                <div class="d-flex flex-column p-4">
                                    <a href="#" class="h4">There are many variations of passages of Lorem Ipsum
                                        available,</a>
                                                ...
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('public/news/img/features-sports-1.jpg') }}" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center features-item">
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('public/news/img/features-technology.jpg') }}" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center features-item">
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('public/news/img/features-fashion.jpg') }}" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center features-item">
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('public/news/img/features-life-style.jpg') }}" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills nav-justified">
                    <li class="nav-item">
                        <button class="tablinks nav-link " onclick="openCity(event, 'Paris')">Featured News</button>
                    </li>

                    <li class="nav-item">
                        <button class="tablinks nav-link" onclick="openCity(event, 'Paris1')">Most Read</button>
                    </li>

                    <li class="nav-item">
                        <a class="tablinks nav-link" data-toggle="pill" onclick="openCity(event, 'Paris2')">Most Recent</a>
                    </li>
                    <li class="nav-item">
                        <a class="tablinks nav-link" data-toggle="pill" onclick="openCity(event, 'Paris3')">Most Viewed</a>
                    </li>
                </ul>

                <div class="tab-content">
                    <div id="Paris" class="container tabcontent tab-pane">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="tn-news">
                                    <div class="tn-img">
                    ...
                    <div id="Paris1" class="container tabcontent tab-pane">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="tn-news">
                                    <div class="tn-img">
                    ...
                    <div id="Paris2" class="container tab-pane tabcontent">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="tn-news">
                                    <div class="tn-img">
                    ...
                    <div id="Paris3" class="container tab-pane tabcontent">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="tn-news">
                                    <div class="tn-img">
