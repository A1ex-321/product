                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"> Banner data <small></small></h3>
                        </div>
                        <div class="container">
                            <form action="{{ route('banner-update', ['id' => $getRecord->id])}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="col-md-6">
    <div class="form-group">
        <label for="exampleInputEmail1">Heading<span style="color:red"></span></label>
        <textarea name="title" class="form-control" id="exampleInputEmail1" placeholder="Heading" style="width: 450px; height: 100px;">
            {{ json_decode($getRecord->title)->title }}
        </textarea>
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
        ...
        <textarea name="description" class="form-control" id="exampleInputEmail1" placeholder="Description" style="width: 100%; height: 100px;">
        {{ json_decode($getRecord->description)->description }}
        </textarea>
    </div>
</div>
