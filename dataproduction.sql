...
CREATE DATABASE IF NOT EXISTS `production` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `production`;

-- Dumping structure for table production.about
...
-- Dumping data for table production.about: ~0 rows (approximately)
...
-- Dumping structure for table production.backgroundimage
...
-- Dumping data for table production.backgroundimage: ~0 rows (approximately)
...
-- Dumping structure for table production.banner
...
-- Dumping data for table production.banner: ~3 rows (approximately)
...
-- Dumping structure for table production.blog
...
-- Dumping data for table production.blog: ~7 rows (approximately)
...
-- Dumping structure for table production.blogimage
...
-- Dumping data for table production.blogimage: ~0 rows (approximately)

-- Dumping structure for table production.blogsco
...
-- Dumping data for table production.blogsco: ~4 rows (approximately)
INSERT INTO `blogsco` (`id`, `title`, `description`, `content`, `image`, `category`, `states`, `check`, `latest`, `read`, `popular`, `viewed`, `recent`, `metatitle`, `metadescription`, `ogtitle`, `ogdescription`, `ogimage`, `ogurl`, `ogtype`, `slug`, `created_at`, `updated_at`) VALUES
	(77, 'ROTARY CONE VACCUME DRYER (RCVD)', '17', '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">\n<html><body><p><img data-filename="1.jpg" style="width: 500px; float: left;" src="http://production.test/public/images/_17170704820.png" class="note-float-left"></p><p>Rotary Cone Vacuum Dryers (RCVD\'s) are completely jacketed for optimum dryer efficiency. Heat transfer fluid, typically hot water, steam or vapour, is circulated around the conical jacket for even product drying through conduction</p><p>Dryer rotates, given the shape of the vessel, the entire product batch is thoroughly mixed and high speed dried. This blending and inter-folding process maintains uniform temperatures and eliminates any probability of product re- condensation due to cold spots. We then use a high vacuum to draw off any remaining moisture</p><p>while the product is in motion and thereafter the batch is easily discharged and cleaned given the conical shape of the vessel</p><p>Application: Pharmaceutical, Food and Chemical sectors</p></body></html>\n', '1717070482_1.jpg', '18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ROTARY CONE VACCUME DRYER (RCVD)', NULL, NULL, NULL, '1717070482_1.jpg', NULL, NULL, 'ROTARY CONE VACCUME DRYER (RCVD)', '2024-05-30 06:31:22', '2024-05-31 05:47:13'),
	(78, 'ROTARY PADDLE VACCUME DRYER (RPVD)', '17', '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">\n<html><body><p><br></p><p><img data-filename="2.jpg" style="width: 50%; float: left;" src="http://production.test/public/images/_17171281760.png" class="note-float-left"><br></p><p>thermic fluid through the jacket, and also through the hollow central shaft and agitator arms. the agitator can be helical ribbons or paddle type.</p><p>The sweeping blades promoted product contact with the heated walls of the dryer, facilitate mixing and help achieve maximum blending and heating action. The hollow shaft and the paddle arms considerably increase the heat transfer area and thus a high heat transfer co-efficient is achieved.</p></body></html>\n', '1717128139_2.jpg', '18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ROTARY PADDLE VACCUME DRYER (RPVD)', NULL, NULL, NULL, '1717128139_2.jpg', NULL, NULL, 'ROTARY PADDLE VACCUME DRYER (RPVD)', '2024-05-30 22:32:19', '2024-05-31 05:47:21'),
	(79, 'UNIVERSAL RIBBON BLENDER (URB)', '17', '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">\n<html><body><p><img data-filename="3.jpg" style="width: 50%; float: left;" src="http://production.test/public/images/_17171284030.png" class="note-float-left"></p><p>Most effective \'powder mixer\' ideal for use in pharmaceutical, bulk drugs, agro chemicals, insecticide, pesticide, veterinary, food processing, spice and allied Industries.</p><p>Application&Atilde;&cent;&acirc;&#130;&not;&acirc;&#132;&cent;s: Dyes, Intermediates, Pigments, Pesticides, Fine Chemicals, Rubber Chemicals, Bulk Drugs, API, Nutraceuticals &amp; Food Process Ect.,</p></body></html>\n', '1717128403_3.jpg', '19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'UNIVERSAL RIBBON BLENDER (URB)', NULL, NULL, NULL, '1717128403_3.jpg', NULL, NULL, 'UNIVERSAL RIBBON BLENDER (URB)', '2024-05-30 22:36:43', '2024-05-31 05:47:24'),
	(80, 'UNIVERSAL SIGMA MIXER(USM)', '17', '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">\n<html><body><p><img data-filename="4.jpg" style="width: 500px; float: left;" src="http://production.test/public/images/_17171284720.png" class="note-float-left"></p><p>The Sigma Mixer with extruder is used for mixing, kneading and extruding of highly viscous mass, sticky and dough like products, Mixing of pastes, rubber, and heavy plastic masses.</p><p>Applications: Food, Rubber, Pharmaceutical, Chemical and agro industries, Dry powder to wet phase mixing</p></body></html>\n', '1717128472_4.jpg', '19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'UNIVERSAL SIGMA MIXER(USM)', NULL, NULL, NULL, '1717128472_4.jpg', NULL, NULL, 'UNIVERSAL SIGMA MIXER(USM)', '2024-05-30 22:37:52', '2024-05-31 05:47:27');

-- Dumping structure for table production.blogscocontent
...
-- Dumping data for table production.blogscocontent: ~0 rows (approximately)
...
-- Dumping structure for table production.brands
...
-- Dumping data for table production.brands: ~0 rows (approximately)
INSERT INTO `brands` (`id`, `name`, `status`, `created_at`, `updated_at`) VALUES
	(8, 'NaattuMaadu', 0, NULL, NULL);

-- Dumping structure for table production.carts
...
-- Dumping data for table production.carts: ~0 rows (approximately)

-- Dumping structure for table production.contact
...
-- Dumping data for table production.contact: ~2 rows (approximately)
...
-- Dumping structure for table production.contacts
...
-- Dumping data for table production.contacts: ~0 rows (approximately)
...
-- Dumping structure for table production.contentblog
...
-- Dumping data for table production.contentblog: ~0 rows (approximately)

-- Dumping structure for table production.detail
...
-- Dumping data for table production.detail: ~5 rows (approximately)
INSERT INTO `detail` (`id`, `category`, `created_at`, `updated_at`) VALUES
	(18, 'MACHINERY FOR DRYING', '2024-05-30 06:10:27', '2024-05-30 06:10:27'),
	(19, 'MACHINERY FOR MIXING', '2024-05-30 06:10:49', '2024-05-30 06:10:49'),
	(20, 'MACHINERY FOR MILLING', '2024-05-30 06:11:02', '2024-05-30 06:11:02'),
	(21, 'CRUSHERS', '2024-05-30 06:11:12', '2024-05-30 06:11:12'),
	(22, 'OTHER PRODUCTS', '2024-05-30 06:11:32', '2024-05-30 06:11:32');

-- Dumping structure for table production.failed_jobs
...
-- Dumping data for table production.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table production.franchise
...
-- Dumping data for table production.franchise: ~7 rows (approximately)
...
-- Dumping structure for table production.gallery
...
-- Dumping data for table production.gallery: ~0 rows (approximately)
...
-- Dumping structure for table production.herogroundimage
...
-- Dumping data for table production.herogroundimage: ~0 rows (approximately)
...
-- Dumping structure for table production.home
...
-- Dumping data for table production.home: ~0 rows (approximately)

-- Dumping structure for table production.machineservice
...
-- Dumping data for table production.machineservice: ~7 rows (approximately)
...
-- Dumping structure for table production.mailstores
...
-- Dumping data for table production.mailstores: ~3 rows (approximately)
INSERT INTO `mailstores` (`id`, `name`, `msg`, `phone`, `created_at`, `updated_at`) VALUES
	...
	(95, 's', 's', 's', '2024-06-01 00:04:05', '2024-06-01 00:04:05');

-- Dumping structure for table production.migrations
...
-- Dumping data for table production.migrations: ~10 rows (approximately)
...
-- Dumping structure for table production.model_has_permissions
...
-- Dumping data for table production.model_has_permissions: ~0 rows (approximately)

-- Dumping structure for table production.model_has_roles
...
-- Dumping data for table production.model_has_roles: ~4 rows (approximately)
...
-- Dumping structure for table production.orders
...
-- Dumping data for table production.orders: ~3 rows (approximately)
...
-- Dumping structure for table production.password_reset_tokens
...
-- Dumping data for table production.password_reset_tokens: ~0 rows (approximately)

-- Dumping structure for table production.permissions
...
-- Dumping data for table production.permissions: ~3 rows (approximately)
...
-- Dumping structure for table production.permission_user
...
-- Dumping data for table production.permission_user: ~0 rows (approximately)

-- Dumping structure for table production.personal_access_tokens
...
-- Dumping data for table production.personal_access_tokens: ~17 rows (approximately)
...
-- Dumping structure for table production.products
...
-- Dumping data for table production.products: ~2 rows (approximately)
...
-- Dumping structure for table production.roles
...
-- Dumping data for table production.roles: ~4 rows (approximately)
...
-- Dumping structure for table production.role_has_permissions
...
-- Dumping data for table production.role_has_permissions: ~4 rows (approximately)
...
-- Dumping structure for table production.scolink
...
-- Dumping data for table production.scolink: ~0 rows (approximately)

-- Dumping structure for table production.service
...
-- Dumping data for table production.service: ~0 rows (approximately)
...
-- Dumping structure for table production.smtp
...
-- Dumping data for table production.smtp: ~0 rows (approximately)
...
-- Dumping structure for table production.socia
...
-- Dumping data for table production.socia: ~2 rows (approximately)
...
-- Dumping structure for table production.soloblog
...
-- Dumping data for table production.soloblog: ~0 rows (approximately)
...
-- Dumping structure for table production.solowork
...
-- Dumping data for table production.solowork: ~0 rows (approximately)
...
-- Dumping structure for table production.tag
...
-- Dumping data for table production.tag: ~10 rows (approximately)
...
-- Dumping structure for table production.users
...
-- Dumping data for table production.users: ~3 rows (approximately)
...
-- Dumping structure for table production.work
...
-- Dumping data for table production.work: ~0 rows (approximately)
